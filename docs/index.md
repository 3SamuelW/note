...
<div class="home-card">
  ...
  <ul>
    ...
    <li><strong><a href="/note/notes/lan/french/grammaire/">法语时态笔记</a></strong>：收录法语 I 至法语 IV 课程所学的全部时态</li>
    <li><strong><a href="/note/notes/bci/">BCI 学习记录</a></strong>：记录有关脑机接口的知识学习笔记和心得</li>
  </ul>
</div>
