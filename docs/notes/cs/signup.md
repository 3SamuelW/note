...
!!! tip "辅修相关课程"
	已参加：数据结构基础/ls/23-24春夏、计算机组成/zs/24-25秋冬、数字逻辑设计/yyc/24-25春夏、面向对象程序设计/wk/24-25春夏、离散数学及其应用/xw/24-25春夏、大数据分析与应用/zdx/25-26秋、计算机前言技术讲座/25-26秋冬<br>
	正在参加：多媒体技术/xj/25-26春<br>	计划参加：操作系统/NA
